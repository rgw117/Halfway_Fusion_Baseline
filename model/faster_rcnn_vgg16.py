...
class VGG_vis_lwir_feature(nn.Module):
    ...
    def forward(self, vis_image, lwir_image):
       ...
       ##################################################################################
        ...
        # Network In Network
        # concatenate_feature = F.avg_pool2d(concatenate_feature, kernel_size=3, stride=1, padding=1) # (N, 1024, 68, 80)
        ...
        # concatenate_feature = self.pool5(concatenate_feature)  # (N, 512, 64, 80)
    ...
    def load_pretrained_layers(self):
        ...
        # Transfer conv. parameters from pretrained model to current model
        for i, param in enumerate(param_names[20:-7]):  # excluding conv6 and conv7 parameters            
        ...
        self.conv1_1_vis.weight.requires_grad = False
        self.conv1_1_vis.bias.requires_grad = False
        self.conv1_2_vis.weight.requires_grad = False
        self.conv1_2_vis.bias.requires_grad = False
        self.conv2_1_vis.weight.requires_grad = False
        self.conv2_1_vis.bias.requires_grad = False
        self.conv2_2_vis.weight.requires_grad = False
        self.conv2_2_vis.bias.requires_grad = False
        ...
        self.conv1_1_lwir.weight.requires_grad = False
        self.conv1_1_lwir.bias.requires_grad = False
        self.conv1_2_lwir.weight.requires_grad = False
        self.conv1_2_lwir.bias.requires_grad = False
        self.conv2_1_lwir.weight.requires_grad = False
        self.conv2_1_lwir.bias.requires_grad = False
        self.conv2_2_lwir.weight.requires_grad = False
        self.conv2_2_lwir.bias.requires_grad = False
...
class FasterRCNNVGG16(FasterRCNN):
    ...
    def __init__( self, n_fg_class=1, ratios=[1/0.41], anchor_scales=[2,2.52,3.18,4,5,6.36,7,8,8.82,9,10,11.2,14.5] ):
